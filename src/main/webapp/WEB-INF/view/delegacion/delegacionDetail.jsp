...
<title>Spring forms :: Ciudad Delegacion details</title>
<link
...
<div class="container">
	<div class="jumbotron">
	<h1><s:message code="ciudaddelegaciondetail"></s:message></h1>
	</div>
	<p><s:message code="delegacioninfo"></s:message></p>
	...
	<c:choose>
		...
		<c:otherwise>
			<div><s:message code="mssg6"></s:message></div>
		</c:otherwise>
	</c:choose>
</div>
	<footer class="footer">
